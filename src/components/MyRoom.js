...
const MyRoom = (props) => {
        ...
        janusRoom.attach(
            {
                ...
                onremotestream: function(stream) {
                    ...
                    console.log("handleID", remoteFeed.getId())
                    let handleId = remoteFeed.getId()
                    console.log( "isMuted:::::" , remoteFeed.isAudioMuted(handleId))
                    ...
                    if($('#remotevideo'+remoteFeed.rfindex).length === 0) {
                        ...
                        $('#videoremote'+remoteFeed.rfindex).append('<video class="rounded centered relative hide" hello="new" id="remotevideo' + remoteFeed.rfindex + '" width="100%" height="100%" autoplay playsinline/>');
    ...
    const muteAudio = () => {
        ...
        console.log("vroomHandle::",handleId)
       console.log("isMuted:", vroomHandle.isAudioMuted(handleId))
      // vroomHandle.muteAudio(handleId)
       //setIsMuted(!vroomHandle.isAudioMuted(handleId))
    }
      ...
      <div id="myvideo" className="container shorter">
        ...
        <div className="icon-container">
          <div className="vidicon">
            {isMuted ? <BsFillCameraVideoFill className="vidIcon" /> : <BsFillCameraVideoFill className="vidIcon" />}
          </div>
